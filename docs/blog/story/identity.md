...
- 器灵：在某些情况下装备可能会自己产生灵性，该灵性被称为器灵，也可以使用某些方法把其它器灵移植到该装备上。每个器灵都具有一定的智慧，某些器灵可能具有特殊的潜质，这些潜质可能会给装备赋予新的特性或新的技能或使原来的特性或技能产生变异（这种变异的好坏视乎具体情况）。概念级武器绝对不会产生器灵、也不能够移植别的器灵
...
这是把概念级武器，即，该武器表示的是刀这个概念本身，所以它的外观可以变化为该概念下的任何其它武器外观
...
由陈制造，外形参考 Warframe 中的星际战甲孙悟空皮肤以及 OverWatch 中的源氏
...
参考 LOL 中皇子的吕布皮肤![吕布-奉先](./lol/lv-bu.webp)

在援护系统中可以用来召唤吕布

##### 特性

- 战争律动![战争律动](./lol/martial-cadence.webp)
  ![战争律动](./lol/martial-cadence-desc.png)
...
| 装备 | 刀、雷劫、星剑、筋斗云、翅膀           | 耀世、天威、潜龙、焚天、天御之灾、风火轮、混天绫 | 闪烁之刃、火枪、生物机甲、光剑、如意金箍棒 |
| 功法 | 雷法、刀修、符道、道法、阿修罗、查克拉 | 剑修、枪修、三头六臂、魔修                       | 枪斗术、援护系统                           |
...
- 螺旋丸：普通螺旋丸到各种变式螺旋丸
- 风遁·螺旋手里剑：添加了风属性查克拉的螺旋丸，以及融合了其它属性查克拉的风遁·螺旋手里剑
- 尾兽玉：造成远程大范围杀伤性伤害
- 神罗天征
- 万象天引
- 地爆天星
...
参考湮灭之潮的骑士系统，援护主要以人形为主，参考主要来源于神话、传说、历史人物等，参考 Fate 动画，需要有相关遗物才能召唤
...
在进行背景介绍前，我们先把外星生物命名为“维”——表示维度

维制作的一具外表为人类女性的躯体，原本用于承载它意识，便于探索人类社会，融入了一点龙族基因，身体机能优于人类，类似于一些超人类影视作品中的超人类身体素质，外表为发育良好的、有充足锻炼的高中女生

在师傅死后，维把之前师傅留下的意识注入到该具躯体中，该躯体拥有师傅生前的意识和记忆，但是在身份认同上不认为自己与师傅为同一人，而是认为自己是一个独立的人。在后续剧情中，仍然对我充当了师傅的作用，并且帮助了我许多。但是由于缺失锚点，该躯体意识会逐渐消散

虽然她反复向我强调不要把她当成师傅，但是在后续剧情中仍然经常把她当做师傅，同时又清晰地认识到师傅已经死去，她实际上是另一个人，不断地处于这种挣扎的状态中

在师傅死后，因为各种原因曾停职过一段时间，在这段时间里，她邀请了我一起共同活动，例如，研究奇异事件、探索秘境，涉及方方面面

在思维共享事件中，因为避免我泄露维与她的秘密，维与她决定把我相关的记忆删除，后来在精神崩溃中，为了帮助我恢复心智，恢复了相关的记忆

在我原来的身体陷入精神崩溃时，在我身体恢复心智中起了极大作用。后来确定无法恢复之后，便决定把该身体作为锚点，师傅的意识最终也完全消失

在确定将该身份作为锚点之后，由于该身体无法承受锚点的副作用（作为锚点需要接受主意识的所有记忆、以及其它有精神烙印的东西），于是维制作出了一具以龙族基因为主，混入了一些人类基因以及其它种族基因的身体，该身体参与承载了一些记忆，以及接收所有精神烙印的东西，并且维与该身体进行了融合
...
- 绝命：刀，主要使用的兵器，缩小版的大刀样式，具有打击敌人弱点 7 次必杀的效果（参考一些游戏 7 杀之后就是超神，但一般有 7 杀之后必死的梗），平常横背在腰后，战斗时使用右手（惯用手）从腰后抽出，该刀在使用的时候会自动生成一条链子绑定使用者的手腕
- 武器箱：参考全职猎人中的凯特的“疯狂小丑”能力，使用时会随机出现适应当前场景的武器，虽然不是什么时候都是理想的武器，斜背 3 个箱子，横放背负 2 个箱子，箱子普遍不大（因为该锚点的身体不高）。各种武器的使用参考影之刃零的武学动作

#### 暗器宗师 + 工具大师

善于使用各种暗器，参考唐门之类的门派

- 衣服：整套衣服藏了许多暗器，上衣参考电锯人中的蕾塞上衣，下衣是运动短裤
- 腰带：藏了许多暗器，以及其它有用的工具包
- 过膝长袜：外观仿古，丝绸长袜，具有防御功能，还有腿环附着一些小工具
- 鞋子：仿古鞋子，鞋尖带有白色小棉球，高科技，全贴合脚型，缓震
- 长袍：仿古长袍，袍内暗藏许多暗器以及小工具
- 百宝袋：参考哆啦 A 梦，附着在长袍内
- 小李飞刀：主暗器
- 针型暗器（暂时还没想好名称）：参考各种修仙小说的针型法宝
- 念线：参考全职猎人玛奇的“念线缝合”能力

#### 其它

- 白袖：提供驱动各种符的法力，由元制作，法力由元补充，右手穿戴
- 黑袖：一件生物袖套，可以变成各种形状，具有硬质外壳，作为主要的防御手段，左手穿戴
- 头带：纹有龙凤样式的图案，蒙住眼睛时可拥有龙女银瞳的效果，侦查的主要手段
- 簪子：两个簪子，一个金银，一个纯玉石，平常用于固定长发，具体效果还没想好。。。。。。
- 各种符：由元制作的各种功能的符
- 天庭诏书（圣旨）：因果律道具，SCP 世界观中的道具
